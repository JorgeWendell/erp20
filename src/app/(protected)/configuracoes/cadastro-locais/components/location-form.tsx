...
export function LocationForm({ location, open: controlledOpen, onOpenChange, trigger }: LocationFormProps) {
  ...
  const dialogContent = (
    <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
      <DialogHeader>
        <DialogTitle>{isEditMode ? "Editar Local" : "Cadastrar Local"}</DialogTitle>
        <DialogDescription>
          {isEditMode
