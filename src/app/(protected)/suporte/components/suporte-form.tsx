...
export function SuporteForm({ userName, userEmail }: SuporteFormProps) {
  ...
  const onSubmit = (data: SuporteFormValues) => {
    sendTicket({ userName, userEmail, titulo: data.titulo, descricao: data.descricao });
  };
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Ex: Erro ao gerar relatório" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
