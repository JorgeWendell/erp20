...
import { OrcamentoProductSearch } from "./orcamento-product-search";
import { OrcamentoCart } from "./orcamento-cart";
  ...
  return (
    <div className="space-y-6">
      ...
      {selectedLocationId ? (
        ...
        <div className="rounded-lg border border-dashed border-slate-300 dark:border-slate-600 p-8 text-center text-muted-foreground">
          Selecione um local para começar a criar orçamento
        </div>
      )}
    </div>
  );
